//класс показа результата прохождения теста по написанию формы глагола
...
public class ShowResultTest1 extends Test1 {
    @Override
...
//        добавление кнопки возврата на главный экран
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowResultTest1.this, MainActivity.class);

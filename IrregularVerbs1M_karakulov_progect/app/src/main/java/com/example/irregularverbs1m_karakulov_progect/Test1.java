//класс начала теста по составлению формы глагола
...
public class Test1 extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
//    номер страницы
    static int page;
...
//    переменная состояния Switch
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test3_start);
        Button test2_start = findViewById(R.id.start1);
        Switch sw = findViewById(R.id.sw3);
...
//        переход на вариант теста в зависимости от значения isChecked
        test2_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isChecked == true) {
//                   переход на тест с 3-мя формами глагола
                    turnPage(0);
                    addRight(0);
                    addNum(0);
                    Intent intent1 = new Intent(Test1.this, Test1_1f.class);
...
//                    переход на тест с 2-мя формами глаголов
                    ...
                    addRight(0);
                    addNum(0);
                    Intent intent1 = new Intent(Test1.this, Test1_1.class);
                    intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent1);
                }

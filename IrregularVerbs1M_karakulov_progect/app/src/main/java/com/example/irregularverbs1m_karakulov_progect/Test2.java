//класс начала теста по выбору формы глагола
...
public class Test2 extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    //    номер страницы
    static int page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test2_start);
        Button test2_start = findViewById(R.id.start2);
        Switch sw = findViewById(R.id.sw2);
...
//                    переход на тест с 3-мя формами глаголов
                    ...
                    addRight(0);
                    addNum(0);
                    Intent intent1 = new Intent(Test2.this, Test2_2f.class);
...
//                    переход на тест с 2-мя формами глаголов
                    Intent intent1 = new Intent(Test2.this, Test2_2.class);
                    intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent1);
                }

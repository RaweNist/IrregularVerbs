//класс показа результата прохождения теста по составлению формы глагола
...
public class ShowResultTest3 extends Test3 {
    @Override
...
//        добавление кнопки возврата на главный экран
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowResultTest3.this, MainActivity.class);

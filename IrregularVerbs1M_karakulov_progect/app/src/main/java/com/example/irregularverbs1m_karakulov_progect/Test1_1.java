//класс страницы теста по составлению одной из ТРЁХ форм неправильного глагола
...
public class Test1_1 extends Test1 {
...
//    массивы для форм глагола
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ImageButton home = findViewById(R.id.home_1);
...
//                переход на следующую страницу теста
                    Intent intent1 = new Intent(Test1_1.this, Test1_1.class);
...
//                    вывод просьбы ввести ответ хотя бы из 2-х букв
                    Toast.makeText(Test1_1.this, R.string.toast,
...
//        условие перехода на экран результата
        if(page>10){
            Intent intent1 = new Intent(Test1_1.this, ShowResultTest1.class);
            intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent1);
        }

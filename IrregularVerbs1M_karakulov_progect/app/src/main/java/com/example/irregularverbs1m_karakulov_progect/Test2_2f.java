//класс страницы теста по выбору одной из ДВУХ форм неправильного глагола
...
public class Test2_2f extends Test2 {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.test2_2f);
        TextView task = (TextView) findViewById(R.id.task);
        TextView pg = (TextView) findViewById(R.id.page);
        ImageButton home = findViewById(R.id.home_2f);
...
//        переход на главеый экран
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Test2_2f.this,MainActivity.class);
...
//        добавление глаголов и неправильных ответов в соответственные списки
        ...
        for (cursor_v1.moveToFirst(),cursor_v2.moveToFirst()
                     , cursor_v1_1.moveToFirst()
                     ,cursor_v1_2.moveToFirst(),
                     cursor_v2_1.moveToFirst(),cursor_v2_2.moveToFirst()
                     ;
             !cursor_v1.isAfterLast();
             cursor_v1.moveToNext(),cursor_v2.moveToNext()
                     , cursor_v1_1.moveToNext()
                     ,cursor_v1_2.moveToNext(),
...
//        обработка нажатия на первый вариант ответа
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(Test2_2f.this, Test2_2f.class);
...
//        условие перехода на экран результата
        if(page>10){
            Intent intent1 = new Intent(Test2_2f.this, ShowResultTest2.class);
            intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent1);
        }

//класс страницы теста по написанию одной из ДВУХ форм неправильного глагола
...
public class Test3_3f extends Test3{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.test1_2f);
        Button bt = findViewById(R.id.var1);
        ImageButton home = findViewById(R.id.home_3f);
...
//        переход на главеый экран
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Test3_3f.this,MainActivity.class);
...
//                переход на следующую страницу теста
                    Intent intent1 = new Intent(Test3_3f.this, Test3_3f.class);
...
//                    вывод просьбы ввести ответ хотя бы из 2-х букв
                    Toast.makeText(Test3_3f.this, R.string.toast,
...
//        условие перехода на экран результата
        if(page>10){
            Intent intent1 = new Intent(Test3_3f.this, ShowResultTest3.class);
            intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent1);
        }
